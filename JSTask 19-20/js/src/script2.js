...
var arr_info = localStorage.getItem('info');
arr_info = JSON.parse(arr_info);
var sortedSkills = _.sortBy(_.union(_.flatMap(arr_info, 'skills')));
var sortedNamesByFriends = _.flatMap(_.sortBy(arr_info, 'friends'), 'name');
var allUsersFreinds = _.union(_.flatMap(_.flatMap(arr_info, 'friends'), 'name'));
